...
import { Search, FolderOpen, ArrowRight, List, GitBranch } from "lucide-react";
import { useProcessContext } from "../../context/ProcessContext";
import { ProcessViewer } from "./ProcessViewer";
import { FullProcessView } from "../admin/FullProcessView";
import { FlowchartViewer } from "../admin/FlowchartViewer";
...
export function ProcessList() {
  ...
  const [viewMode, setViewMode] = useState<"interactive" | "full" | "flowchart">("interactive");
